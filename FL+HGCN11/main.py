...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset",
                        help='data set:PROTEINS/Fingerprint/NCI1/IMDB-MULTI/Mutagenicity/ENZYMES/DD/IMDB-BINARY/Mutagenicity',
    ...
    parser.add_argument('--model_clients', help='data set:GCN/GIN/HGCN/GAT/GraphSAGE',
    ...
    # parser.add_argument('--gc_model', type=str, default="HGCN")  # HGCN
    # parser.add_argument('--gc_lr', type=float, default=0.01)
    parser.add_argument('--gc_epoch', type=float, default=4)
